...
Ordem [sugerida pela Emily Baches](https://continuous-delivery.co.uk/downloads/Emily-Baches-Guide-to-Code-Katas-for-learning-TDD.pdf)

- First katas
    - [Leap Years](https://sammancoaching.org/kata_descriptions/leap_years.html)
    - [FizzBuzz](https://sammancoaching.org/kata_descriptions/fizzbuzz.html)
- Katas for pure functions
    - [Tennis](https://sammancoaching.org/kata_descriptions/tennis.html)
    - [Christmas Song](https://sammancoaching.org/kata_descriptions/christmas_song.html)
    - [Shopping Basket](https://sammancoaching.org/kata_descriptions/shopping_basket.html)
- Katas with modules and classes
    ...
    - [Monty Hall](https://sammancoaching.org/kata_descriptions/monty_hall.html)
- Side Effects and Mocks
    - [Birthday Greetings](https://sammancoaching.org/kata_descriptions/birthday_greetings.html)

---

From: <https://github.com/garora/TDD-Katas/blob/main/KatasReadme.md>
